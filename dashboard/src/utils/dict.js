...
export const AFTER_SALE_STATUS = {
  ...
  1: { label: '通过待寄回', type: 'primary' },
  2: { label: '买家已寄回', type: 'primary' },
  3: { label: '商家已收货', type: 'primary' },
...
export function orderStatusText(s) {
  return (ORDER_STATUS[s] || {}).label || '-'
}

export const COUPON_STATE = {
  NOT_STARTED: { label: '未开始', type: 'info' },
  ONGOING: { label: '进行中', type: 'success' },
  SOLD_OUT: { label: '已抢光', type: 'warning' },
  ENDED: { label: '已结束', type: 'info' },
  STOPPED: { label: '已停发', type: 'danger' },
}

export const COUPON_STATE_TABS = [
  { label: '全部', value: undefined },
  { label: '进行中', value: 'ONGOING' },
  { label: '未开始', value: 'NOT_STARTED' },
  { label: '已抢光', value: 'SOLD_OUT' },
  { label: '已结束', value: 'ENDED' },
  { label: '已停发', value: 'STOPPED' },
]
